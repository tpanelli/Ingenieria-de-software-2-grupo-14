...
<div class="registrar">
	    ...
	    <form  name="agregar" method="post" action="registrarvehiculo.php" class="input" enctype="multipart/form-data" onsubmit="return validarAgregar()">
				...
				<input type="text" class="caballo" name="patente" title="Debe contener solo letras y numeros (sin espacios)" pattern="^[A-Za-z0-9]+$" required/>
				...
				<input type="number" class="caballo" name="capacidad" title="Debe contener numeros" pattern="^[0-9]+$" min="1" max="60" required/> 
				...
				<label style="color: black"> Imagen (opcional) </label>
